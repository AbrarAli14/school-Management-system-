                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select required id="exam_id" name="exam_id" data-placeholder="Select Exam" class="form-select">
                                    @foreach($exams as $ex)
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select required onchange="getClassSubjects(this.value)" id="my_class_id" name="my_class_id" class="form-select">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select required id="section_id" name="section_id" data-placeholder="Select Class First" class="form-select">
                                   @if($selected)
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select required id="subject_id" name="subject_id" data-placeholder="Select Class First" class="form-select">
                                  @if($selected)
