                        ...
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('subjects.store') }}">
                                ...
                                <div class="form-group row m-1 p-1">
                                    ...
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select Class" class="form-select" name="my_class_id" id="my_class_id">
                                            <option value=""></option>
                                            @foreach($my_classes as $c)
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Select Teacher" class="form-select" name="teacher_id" id="teacher_id">
                                            <option value=""></option>
