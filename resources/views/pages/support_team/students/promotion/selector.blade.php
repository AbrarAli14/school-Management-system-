                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required onchange="getClassSections(this.value, '#fs')" id="fc" name="fc" class="form-select">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required id="fs" name="fs" data-placeholder="Select Class First" class="form-select">
                                @if($selected && $fs)
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required onchange="getClassSections(this.value, '#ts')" id="tc" name="tc" class="form-select">
                                <option value="">Select Class</option>
                                @foreach($my_classes as $c)
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required id="ts" name="ts" data-placeholder="Select Class First" class="form-select">
                                @if($selected && $ts)
