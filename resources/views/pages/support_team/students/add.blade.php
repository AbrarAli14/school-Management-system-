                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="gender" name="gender" required data-fouc data-placeholder="Choose..">
                                    <option value=""></option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select placeholder="Choose..." required name="nal_id" id="nal_id" class="form-select">
                        ...
                        <div class="col-md-3">
                            ...
                            <select onchange="getLGA(this.value)" required data-placeholder="Choose.." class="form-select" name="state_id" id="state_id">
                                    <option value="">Choose</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select required data-placeholder="Select State First" class="form-select" name="lga_id" id="lga_id">
                                    <option value="">Choose</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="bg_id" name="bg_id" >
                                    <option value="">Choose</option>
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select onchange="getClassSections(this.value)" data-placeholder="Choose..." required name="my_class_id" id="my_class_id" class="form-select">
                                    <option value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select data-placeholder="Select Class First" required name="section_id" id="section_id" class="form-select">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select data-placeholder="Choose..."  name="my_parent_id" id="my_parent_id" class="form-select">
                                    <option  value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select data-placeholder="Choose..." required name="year_admitted" id="year_admitted" class="form-select">
                                    <option value=""></option>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <select data-placeholder="Choose..."  name="dorm_id" id="dorm_id" class="form-select">
                                <option value=""></option>
                                @foreach($dorms as $d)
