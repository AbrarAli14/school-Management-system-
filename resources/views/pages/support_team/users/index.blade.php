                        ...
                        <fieldset>
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select required data-placeholder="Select User" class="form-select" name="user_type" id="user_type">
                                @foreach($user_types as $ut)
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" id="gender" name="gender" required data-fouc >
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select required name="nal_id" id="nal_id" class="form-select">
                                            <option value="">Choose...</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select required  class="form-select" name="lga_id" id="lga_id">
                                        <option value="">Choose...</option>
                                    </select>
                                </div>
                                {{--BLOOD GROUP--}}
