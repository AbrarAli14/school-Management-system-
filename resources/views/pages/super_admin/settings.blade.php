            ...
            <div class="row">
                <div class="col-md-6 border-right-2 border-right-blue-400">
                        ...
                        <div class="form-group row m-1 p-1">
                            ...
                            <div class="col-lg-6">
                                <input name="term_ends" value="{{ $s['term_ends'] }}" type="date" class="form-control " placeholder="Date Term Ends">
                            </div>
                        ...
                        <div class="form-group row m-1 p-1">
                            ...
                            <div class="col-lg-6">
                                <input name="term_begins" value="{{ $s['term_begins'] }}" type="date" class="form-control " placeholder="Date Term Ends">
                            </div>
                            <div class="col-lg-3 mt-2">
                                <span class="font-weight-bold font-italic">M-D-Y or M/D/Y </span>
                            </div>
